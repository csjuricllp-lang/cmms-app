    ...
    const standardRoles = [
      {
        ...
        permissions: ['assets.read', 'assets.create', 'assets.update', 'assets.delete', 'pm.read', 'pm.create', 'pm.update', 'pm.delete', 'work-orders.read', 'work-orders.read-all', 'work-orders.create', 'work-orders.update', 'work-orders.delete', 'requests.read', 'requests.create', 'requests.update', 'requests.delete', 'locations.read', 'locations.create', 'locations.update', 'locations.delete', 'parts.read', 'parts.create', 'parts.update', 'parts.delete', 'analytics.view', 'analytics.read', 'dashboard.access', 'checklists.read', 'checklists.create', 'checklists.update', 'checklists.delete', 'po.read', 'po.create', 'po.update', 'po.delete', 'vendors.read', 'customers.read', 'data.manage', 'workflows.manage', 'workflows.read']
      },
      {
