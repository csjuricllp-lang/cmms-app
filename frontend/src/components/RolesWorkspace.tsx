        ...
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-start justify-between">
                ...
                <button 
                    ...
                    className="px-5 py-2.5 bg-primary text-white text-[13px] font-bold rounded-xl shadow-md shadow-primary/20 hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/20 active:scale-95 transition-all flex items-center gap-2 whitespace-nowrap shrink-0"
                >
            ...
            <div className="bg-card rounded-[32px] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] overflow-x-auto max-h-[500px] overflow-y-auto">
                <table className="w-full border-collapse">
                    <thead>
                        <tr className="border-b border-gray-50 bg-transparent sticky top-0 z-10">
                            <th className="px-8 py-6 text-left text-[11px] font-black uppercase tracking-widest text-slate-400 sticky top-0 bg-muted/50 z-10">Name</th>
                            <th className="px-8 py-6 text-left text-[11px] font-black uppercase tracking-widest text-slate-400 sticky top-0 bg-muted/50 z-10">Users</th>
                            <th className="px-8 py-6 text-left text-[11px] font-black uppercase tracking-widest text-slate-400 sticky top-0 bg-muted/50 z-10">External ID</th>
                            <th className="px-8 py-6 text-left text-[11px] font-black uppercase tracking-widest text-slate-400 sticky top-0 bg-muted/50 z-10">Type</th>
                        </tr>
                    </thead>
                        ...
                        {isLoadingRoles ? (
                            ...
                            roles.map((role) => (
                                ...
                                >
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-4">
                                            <div className={cn(
                                                ...
                                                !role.isSystem ? "bg-primary/10 text-primary" : "bg-muted/50 text-slate-400"
                                            )}>
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-[15px] font-bold text-foreground/90">{role.name}</span>
                                                {role.isSystem && <span className="text-[11px] font-black uppercase text-primary/80 tracking-widest mt-0.5">System Default</span>}
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                    ...
                                    <td className="px-8 py-6">
                                        <code className="px-3 py-1 bg-muted/50 border border-slate-100 rounded-lg text-[13px] font-bold text-muted-foreground font-mono">
                                    ...
                                    <td className="px-8 py-6">
                                        <span className={cn(
                                            ...
                                            !role.isSystem 
                                                ...
                                                : "bg-muted/50 text-slate-400 border border-slate-100"
                                        )}>
