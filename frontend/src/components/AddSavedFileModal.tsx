...
export const AddSavedFileModal: React.FC<AddSavedFileModalProps> = ({ isOpen, onClose, workOrderId }) => {
    ...
    return (
        <div className="fixed inset-0 z-[600] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-[580px] bg-card rounded-[24px] shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200 min-h-[600px]">
                {/* Header */}
                ...
                <div className="p-8 flex-1 flex flex-col">
                    ...
                    <div className="relative mb-8">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3 bg-card border border-primary/80 rounded-xl text-[14px] font-bold text-slate-600 outline-none shadow-[0_0_0_4px_rgba(59,130,246,0.1)] transition-all"
                        />
                    </div>
                    ...
                    <div className="flex items-center justify-end gap-4 pt-6 border-t border-gray-50">
                        ...
                        <button
                            disabled
                            className="px-10 py-3 bg-primary text-white rounded-xl text-[15px] font-black transition-all active:scale-95 disabled:opacity-50 shadow-lg shadow-primary/20"
                        >
                            Add Files
                        </button>
                    </div>
