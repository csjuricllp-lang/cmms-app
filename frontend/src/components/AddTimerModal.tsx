        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <motion.div 
                    ...
                    className="relative w-full max-w-[580px] bg-card rounded-[1.25rem] shadow-[0_20px_70px_rgba(0,0,0,0.25)] overflow-hidden"
                >
                    {/* Header */}
                    ...
                    <div className="px-10 pb-12">
                        <div className="relative">
                            <input 
                                ...
                                className="w-full h-[72px] bg-card border-[2px] border-blue-200 rounded-xl px-6 text-[22px] font-medium text-foreground/90 outline-none focus:border-primary/80 focus:ring-[4px] focus:ring-primary/20 transition-all shadow-sm"
                            />
                        </div>
                    </div>

                    {/* Footer - Exactly like image */}
                    <div className="flex items-center justify-end gap-4 px-10 pb-10 bg-card">
                        <button 
                            onClick={onClose}
                            className="px-8 py-4 rounded-xl text-[20px] font-semibold text-slate-600 hover:bg-muted/50 border border-border transition-all min-w-[140px]"
                        >
                            Cancel
                        </button>
                        <button 
