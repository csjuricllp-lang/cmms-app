                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-muted/50 rounded-2xl p-5 border border-slate-100 flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[14px] font-bold text-foreground">Active Vendor</p>
                            </div>
                        </div>
                        <div className="bg-muted/50 rounded-2xl p-5 border border-slate-100 flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm space-y-6">
                            <div>
                                ...
                                <p className="text-[14px] font-medium text-foreground">{vendor.contactName || <span className="text-slate-300 italic">Not Provided</span>}</p>
                            </div>
                            <div>
