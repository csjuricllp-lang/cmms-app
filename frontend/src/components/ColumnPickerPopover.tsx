...
export const ColumnPickerPopover: React.FC<ColumnPickerPopoverProps> = ({
    ...
    return (
        <>
            ...
            <div 
                className="fixed z-[260] w-64 bg-card border border-slate-100 rounded-xl shadow-2xl overflow-hidden py-3 animate-in fade-in zoom-in-95 duration-200"
                style={{ 
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={cn(
                                    ...
                                    isVisible ? "bg-primary border-primary" : "bg-card border border-slate-300"
                                )}>
