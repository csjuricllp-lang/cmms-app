    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
            ...
            <motion.div 
                ...
                className="relative w-full max-w-[650px] bg-card rounded-xl shadow-2xl overflow-hidden"
            >
                ...
                <div className="p-8 space-y-10">
                    ...
                    <div className="space-y-3">
                        <label className="text-[14px] font-bold text-foreground/90 flex items-center gap-1">
                        ...
                        <input 
                            ...
                            placeholder=""
                            className="w-full px-5 py-3.5 bg-card border border-rose-500 rounded-lg text-[15px] font-medium focus:ring-2 focus:ring-rose-500/20 outline-none transition-all"
                        />
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative group">
                            <select 
                                ...
                                className="w-full px-5 py-3.5 bg-card border border-border rounded-lg text-[15px] font-medium focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all appearance-none cursor-pointer"
                            >
                            ...
                            <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none group-focus-within:text-primary transition-colors" />
                        </div>
                    </div>
