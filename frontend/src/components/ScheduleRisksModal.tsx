...
export const ScheduleRisksModal: React.FC<ScheduleRisksModalProps> = ({ 
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-4xl bg-card rounded-[24px] shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-300">
                {/* Header */}
                <div className="px-8 py-6 border-b border-gray-100 flex items-center justify-between bg-card sticky top-0 z-10">
                    <div>
                ...
                <div className="flex-1 overflow-y-auto p-8 bg-background">
                    <div className="bg-card border border-gray-100 rounded-3xl shadow-sm overflow-hidden">
                        <div className="p-6 border-b border-gray-50 flex items-center justify-between group">
                            <div className="flex items-center gap-4">
                                <ChevronDown className="w-5 h-5 text-slate-400" />
                                <div className="flex items-center gap-3">
                                    <h3 className="text-[16px] font-black text-foreground/90">Work Orders Overdue</h3>
                            ...
                            <button 
                                ...
                                className="px-4 py-2 bg-blue-50 text-primary text-[13px] font-black rounded-xl border border-blue-100 hover:bg-blue-100 transition-all active:scale-95"
                            >
                                Remove All
                            </button>
                        </div>
                        ...
                        <div className="px-6 pb-6 pt-2">
                             ...
                             <div className="border border-gray-100 rounded-2xl overflow-hidden bg-card">
                                        ...
                                        {overdueOrders.map(wo => (
                                            <tr key={wo.id} className="hover:bg-slate-50/30 transition-colors">
                                                <td className="px-6 py-5">
                                                    <Link to={`/work-orders?id=${wo.id}`} className="text-[13px] font-bold text-primary hover:underline decoration-2 underline-offset-4">
                                                        {wo.title}
                                                    </Link>
                                                </td>
                                                ...
                                                <td className="px-6 py-5 text-[13px] font-bold text-muted-foreground capitalize">
                                                ...
                                                <td className="px-6 py-5">
                                                    <button 
                                                        ...
                                                        className="px-4 py-2 bg-blue-50 text-primary text-[12px] font-black rounded-lg border border-blue-100 hover:bg-blue-200 transition-all active:scale-95 whitespace-nowrap"
                                                    >
                ...
                {/* Footer */}
                <div className="px-8 py-5 border-t border-gray-100 bg-card flex justify-end">
                    <button 
                        onClick={onClose}
                        className="px-6 py-2 bg-card border border-border text-slate-600 rounded-xl text-[14px] font-black hover:bg-muted/50 transition-all active:scale-95"
                    >
                        Close
                    </button>
                </div>
