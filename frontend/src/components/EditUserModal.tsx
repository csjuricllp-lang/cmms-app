...
export const EditUserModal = ({ user, onClose }: EditUserModalProps) => {
    ...
    const inputClasses = "w-full h-10 px-3 bg-card border border-border rounded-md text-[14px] focus:outline-none focus:border-primary/80 transition-colors";
        ...
        >
            ...
            >
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <h3 className="text-[16px] font-bold text-foreground">Edit Profile: {user.name}</h3>
                ...
                <div className="flex items-center justify-end gap-3 px-6 py-4 bg-muted/50 border-t border-gray-100">
                    <button 
                        onClick={onClose}
                        className="px-4 py-2 text-[14px] font-medium text-gray-600 hover:text-foreground transition-colors"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        className="px-4 py-2 bg-primary text-white rounded-md text-[14px] font-medium hover:bg-primary/90 transition-colors flex items-center gap-2 disabled:opacity-50"
                    >
