...
export const AssetHeaderActionsPopover: React.FC<AssetHeaderActionsPopoverProps> = ({
    ...
    return (
        <>
            ...
            <div 
                className="fixed z-[260] w-[320px] bg-card border border-slate-100 rounded-xl shadow-2xl overflow-hidden py-1 animate-in fade-in zoom-in-95 duration-200"
                style={{ 
            ...
            >
                <button
                    ...
                    className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-muted/50 transition-colors group"
                >
                    <Upload className="w-5 h-5 text-slate-400 group-hover:text-primary" />
                    <span className="text-[17px] font-medium text-foreground/90">Import</span>
                </button>
                ...
                <button
                    ...
                    className="w-full flex items-start gap-3 px-5 py-4 hover:bg-muted/50 transition-colors group text-left"
                >
                    <QrCode className="w-5 h-5 text-slate-400 mt-0.5 group-hover:text-primary" />
                    <div className="flex flex-col">
                        <span className="text-[17px] font-medium text-foreground/90">Download & Generate</span>
                ...
                >
                    <QrCode className="w-5 h-5 text-slate-400 mt-0.5 group-hover:text-primary" />
                    <div className="flex flex-col">
                        <span className="text-[17px] font-medium text-foreground/90">Download Labels</span>
