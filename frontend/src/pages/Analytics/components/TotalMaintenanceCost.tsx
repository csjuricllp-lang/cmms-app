                ...
                <Widget title="Downtime and Costs" icon={Info} data={correlationData} className="h-[500px]">
                    <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={correlationData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                            ...
                            <YAxis yAxisId="right" orientation="right" axisLine={false} tickLine={false} tick={{ fontSize: 10, fill: 'hsl(var(--primary-raw))' }} label={{ value: 'Total Maintenance Cost', angle: 90, position: 'insideRight', style: { fill: 'hsl(var(--primary-raw))', fontSize: 10, fontWeight: 'bold' } }} />
                            ...
                            <Line yAxisId="right" type="monotone" dataKey="cost" stroke="#6366F1" strokeWidth={3} dot={{ r: 4, fill: 'hsl(var(--primary-raw))' }} name="Total Maintenance Cost" />
                        </ComposedChart>
                    </ResponsiveContainer>
                </Widget>
                ...
                <Widget title="Downtime and Cost Trends" icon={Info} data={trendCorrelation} className="h-[500px]">
                    <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={trendCorrelation} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                            ...
                            <YAxis yAxisId="right" orientation="right" axisLine={false} tickLine={false} tick={{ fontSize: 10, fill: 'hsl(var(--primary-raw))' }} />
                            <Tooltip contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }} />
                            <Legend align="center" verticalAlign="bottom" />
