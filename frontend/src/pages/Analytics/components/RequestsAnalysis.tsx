        ...
        <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="bg-card p-10 rounded-[32px] border border-slate-100 shadow-sm flex flex-col items-center justify-center text-center min-h-[320px] group hover:border-primary/10 transition-all cursor-default">
                    ...
                    <div className="mt-4 text-[11px] font-bold text-slate-300 bg-transparent px-3 py-1 rounded-full border border-slate-100">
                ...
                <div className="bg-card p-10 rounded-[32px] border border-slate-100 shadow-sm flex flex-col items-center justify-center text-center min-h-[320px] group hover:border-border transition-all cursor-default">
                    <div className="w-16 h-16 bg-transparent rounded-[24px] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Priority Breakdown */}
                <div className="bg-card p-10 rounded-[40px] border border-slate-100 shadow-sm min-h-[480px]">
                        ...
                        <div className="flex items-center justify-center gap-8 mt-4">
                            {byPriority.length > 0 ? byPriority.map((item: any, idx: number) => (
                                <div key={item.name} className="flex items-center gap-2">
                                    ...
                                    <span className="text-[12px] font-black text-muted-foreground uppercase tracking-tighter italic">{item.name} {((item.value / byPriority.reduce((a: any, b: any) => a + b.value, 0)) * 100).toFixed(1)}%</span>
                                </div>
                            )) : (
