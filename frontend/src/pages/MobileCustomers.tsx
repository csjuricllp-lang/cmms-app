      ...
      <div className="bg-card px-4 py-4 border-b border-slate-100 sticky top-0 z-30 shadow-sm flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-[17px] font-black text-foreground tracking-tight">Customers</h1>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-card rounded-3xl border border-border p-12 text-center my-6 space-y-4">
            ...
            <div className="space-y-1">
              <p className="text-[14px] font-black text-foreground/90">No Customers Found</p>
                  ...
                  <div className="flex-1 min-w-0 space-y-2">
                    <div className="space-y-0.5">
                      <div className="flex items-center justify-between gap-2">
                        <h3 className="text-[14px] font-black text-foreground leading-tight truncate">
                          {cust.name}
                        </h3>
                        <span className="px-2 py-0.5 rounded text-[9px] font-extrabold bg-primary/10 text-primary/90 border border-primary/10 uppercase tracking-wider shrink-0">
                          {cust.type || 'Internal'}
                        </span>
                      </div>
                    </div>
